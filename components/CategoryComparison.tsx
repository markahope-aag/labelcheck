    ...
    <div className="bg-white rounded-lg border-2 border-purple-400 p-6 shadow-lg">
      ...
      <div className="overflow-x-auto">
        <div
          ...
          style={{ gridTemplateColumns: `repeat(${categoryOptionsData.length}, 1fr)` }}
        >
          {categoryOptionsData.map((option) => (
            ...
            >
              ...
              <div className="p-4 border-b border-gray-200 bg-gray-50">
                ...
                {/* Compliance Status */}
                <div
                  className={`flex items-center gap-2 text-sm font-medium ${option.currentLabelCompliant ? 'text-green-600' : 'text-red-600'}`}
                >
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {option.requiredChanges.map((change, idx) => (
                        <li
                          key={idx}
                          className="text-xs text-gray-700 pl-3 border-l-2 border-red-300"
                        >
                          {change}
                        </li>
                      ))}
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {option.pros.map((pro, idx) => (
                        <li
                          key={idx}
                          className="text-xs text-gray-700 pl-3 border-l-2 border-green-300"
                        >
                          {pro}
                        </li>
                      ))}
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {option.allowedClaims.slice(0, 5).map((claim, idx) => (
                        <li
                          key={idx}
                          className="text-xs text-gray-700 pl-3 border-l-2 border-blue-300"
                        >
                          {claim}
                        </li>
                      ))}
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {option.prohibitedClaims.slice(0, 5).map((claim, idx) => (
                        <li
                          key={idx}
                          className="text-xs text-gray-700 pl-3 border-l-2 border-orange-300"
                        >
                          {claim}
                        </li>
                      ))}
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {option.regulatoryRequirements.slice(0, 3).map((req, idx) => (
                        <li
                          key={idx}
                          className="text-xs text-gray-600 pl-3 border-l-2 border-gray-300"
                        >
                          {req}
                        </li>
                      ))}
