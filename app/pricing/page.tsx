  ...
  const plans = [
    {
      ...
      price: billingInterval === 'monthly' ? PLAN_PRICES.starter.monthly : PLAN_PRICES.starter.annual / 12,
    ...
    },
    {
      ...
      price: billingInterval === 'monthly' ? PLAN_PRICES.professional.monthly : PLAN_PRICES.professional.annual / 12,
    ...
    },
    {
      ...
      description: 'For large teams with high-volume requirements',
      price: billingInterval === 'monthly' ? PLAN_PRICES.business.monthly : PLAN_PRICES.business.annual / 12,
