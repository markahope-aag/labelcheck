                ...
                <div className="flex-1">
                  ...
                  {analysis.label_name &&
                    ...
                    analysis.label_name !== result.product_name && (
                      <p className="text-sm text-slate-500 mt-1">Product: {result.product_name}</p>
                    )}
                  <CardDescription>
                          ...
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span
                              className={`px-2 py-1 rounded text-xs font-semibold ${
                                result.general_labeling.statement_of_identity.status === 'compliant'
                                  ? 'bg-green-100 text-green-800'
                            ...
                            <span
                              className={`px-2 py-1 rounded text-xs font-semibold ${
                                result.general_labeling.net_quantity.status === 'compliant'
                                  ? 'bg-green-100 text-green-800'
                                  : result.general_labeling.net_quantity.status === 'non_compliant'
                                    ? 'bg-red-100 text-red-800'
                                    : 'bg-gray-100 text-gray-800'
                              }`}
                            >
                      ...
                      {result.general_labeling.manufacturer_address && (
                        <div className="bg-slate-50 rounded-lg p-4">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span
                              className={`px-2 py-1 rounded text-xs font-semibold ${
                                result.general_labeling.manufacturer_address.status === 'compliant'
                                  ? 'bg-green-100 text-green-800'
                          ...
                          <span
                            className={`px-2 py-1 rounded text-xs font-semibold ${
                              result.allergen_labeling.status === 'compliant'
                                ? 'bg-green-100 text-green-800'
                                : result.allergen_labeling.status === 'potentially_non_compliant'
                                  ? 'bg-yellow-100 text-yellow-800'
                                  : 'bg-red-100 text-red-800'
                            }`}
                          >
