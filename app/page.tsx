        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Check allergens, GRAS, and claims—not just nutrition facts—in minutes. From $49/month.
              No $240+ consultant fees.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="text-lg px-8" asChild>
                <Link href="/sign-up">Start Free Trial - 10 Analyses</Link>
              </Button>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">Three simple steps to ensure compliance</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">
                  Simply upload a photo or image of your packaging label. We accept JPG, PNG, and
            ...
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">
                  Our advanced AI analyzes your label against FDA and USDA regulations in seconds,
            ...
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">
                  Receive a detailed compliance report with actionable recommendations to fix any
                  issues found.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Unlike nutrition generators that only check nutrition panels, we verify allergens,
                  GRAS, claims, and all FDA/USDA requirements
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Get comprehensive compliance reports in 60 seconds vs. 1-2 weeks with regulatory
                  consultants
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  $49-399/month vs. $240+ per consultant review. Unlimited revisions included. Break
                  even after just 1 review
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Automatic detection of FALCPA/FASTER allergens with 400+ derivatives. Catches
                  hidden sources like "whey" (milk) and "albumin" (eggs)
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  1,465 FDA-approved GRAS ingredients for foods and 1,253 NDI notifications + 2,193
                  grandfathered ingredients for supplements
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Flags prohibited health claims, misleading marketing terms, and unsubstantiated
      ...
      <section className="py-20 border-t">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 text-sm mb-6">Perfect for small brands with 3-5 SKUs</p>
            ...
            <Card className="border-2 border-blue-600 relative">
              ...
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 text-sm mb-6">For growing brands with 10-20 SKUs</p>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0" />
            ...
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 text-sm mb-6">For large brands with 50+ SKUs</p>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0" />
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-4">Save 17% with annual billing (2 months free)</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="pt-6">
                <p className="text-gray-600 mb-4">
                  "LabelCheck saved us weeks of back-and-forth with regulatory consultants. The AI
                  catches issues we would have missed."
                </p>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="text-gray-600 mb-4">
                  "We've reduced our time to market by 40% using LabelCheck. The detailed reports
                  make it easy to fix issues quickly."
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gray-200 rounded-full"></div>
                  <div>
                    ...
                    <p className="text-gray-500 text-xs">
                      Compliance Director, Organic Snacks Inc.
                    </p>
                  </div>
                </div>
              </CardContent>
